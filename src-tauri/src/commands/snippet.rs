...
#[tauri::command]
pub async fn snippet_add(snippet: Snippet, db: State<'_, DbManager>) -> Result<(), TmaxError> {
...
#[tauri::command]
pub async fn snippet_list(db: State<'_, DbManager>) -> Result<Vec<Snippet>, TmaxError> {
    tracing::debug!("Listing snippets");
    Ok(db.list_snippets()?)
}

#[tauri::command]
pub async fn snippet_delete(id: String, db: State<'_, DbManager>) -> Result<(), TmaxError> {
...
#[tauri::command]
pub async fn snippet_update(snippet: Snippet, db: State<'_, DbManager>) -> Result<(), TmaxError> {
